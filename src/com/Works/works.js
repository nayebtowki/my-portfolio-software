...
const Works = ({nayebtowki}) => {
    ...
    return (
        <section id='works'>
            ...
            <span className="worksDesc">Dive into a showcase where precision meets innovation. Here, I present a collection of my projects, each a testament to my commitment to excellence and meticulous attention to detail. From crafting secure and intuitive web applications to exploring the frontiers of machine learning, my portfolio reflects my journey in blending technical expertise with creative problem-solving. I'm enthusiastic about leveraging these skills to help businesses and individuals establish a formidable online presence and navigate the ever-evolving digital landscape.</span>
